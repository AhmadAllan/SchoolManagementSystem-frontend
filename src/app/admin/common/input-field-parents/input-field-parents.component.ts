...
@Component({
  selector: 'app-input-field-parents',
  templateUrl: './input-field-parents.component.html',
  styleUrls: ['./input-field-parents.component.css']
})
export class InputFieldParentsComponent {
  faAdd = faAdd;
  faXmark = faXmark;
  ...
  @Output() parentAdded = new EventEmitter<void>();

  
  constructor (private formBuilder: FormBuilder,private customVadlidator: CustomValidationService, private parentService: ParentService) {}
